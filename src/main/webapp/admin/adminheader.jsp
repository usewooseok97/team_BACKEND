...
<title>회원 관리 - WORK OUT</title>
 <link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath}/admin/css/adminstyle.css">
...
<body>
    <nav class="navbar">
        ...
        <div class="nav-right">
            <span style="color: white; margin-right: 20px;">${lang == 'ko' ? '관리자' : 'ADMIN'} ${sessionScope.user.name}</span>
