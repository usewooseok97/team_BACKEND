...
<div class="exercise-container">
    <div class="exercise-header">
        <h1>${lang == 'ko'? '운동 종류' : 'EXERCISE LIST' }</h1>
    </div>
                    ...
                    <div class="exercise-card">
                        ...
                        <c:if test="${not empty exercise.primaryMuscles}">
                            <div class="exercise-info">
                                <strong class = "exercise-name">${lang == 'ko'? '주요 근육:' : 'PRIMARY MUSCLES' }</strong>
                        ...
                        <c:if test="${not empty exercise.secondaryMuscles}">
                            <div class="exercise-info">
                                <strong class = "exercise-name">${lang == 'ko'? '보조 근육:' : 'SECONDARY MUSCLES' }</strong>
                        ...
                        <c:if test="${not empty exercise.level}">
                            <div class="exercise-info">
                                <strong class="badge badge-equipment">${lang == 'ko'? '난이도:' : 'LEVEL' }</strong> <span class="badge badge-equipment">${exercise.level}</span>
                            </div>
                        </c:if>
